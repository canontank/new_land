...
async function fetchRealEstateData() {
  const spinner = document.getElementById('realestate-loading-spinner') || document.getElementById('loading-spinner');
  const dataContainer = document.getElementById('realestate-data-container') || document.getElementById('data-container');

  if (!spinner || !dataContainer) return;
